import { Icon, Table, EdsProvider, Checkbox, Dialog as Dialog$1, Button, DotProgress, Tooltip as Tooltip$1, Typography, NativeSelect, Pagination as Pagination$2, Label as Label$1, TextField as TextField$2 } from '@equinor/eds-core-react';
...
const Header$1 = ({ children, id }) => {
    ...
    if (!state.dataTableReducer.columns)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Head$1, { children: jsxs(Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsx$1(CheckboxHeaderCell, {}, "checkbox-header")), state.columnSelectorReducer && ((_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsx$1(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))), !state.columnSelectorReducer && ((_b = state.dataTableReducer.columns) === null || _b === void 0 ? void 0 : _b.filter((x) => !x.props.optional).map((column) => (jsx$1(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id))))] }), void 0) }, void 0));
};
...
const StickyHeader$1 = forwardRef((props, ref) => {
    ...
    if (!state.stickyHeaderReducer.width)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(StickyTable, Object.assign({ stick: stick, threshold: threshold }, { children: jsx$1(Head, Object.assign({ id: `dataTable.stickyHeaderRow.${id}` }, { children: jsxs(Table.Row, { children: [state.checkboxReducer && (jsx$1(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsx$1(HeaderCell, { width: state.stickyHeaderReducer.width[column.props.id], id: `sticky-${column.props.id}`, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))] }, void 0) }), void 0) }), void 0));
});
...
const Header = styled.div `
    ...
    white-space: nowrap;
`;
const ValidationError = styled(Label$1) `
    color: rgb(235, 0, 0);
    margin-top: 4px;
    height: 16px;
`;
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        ...
        return (jsxs(InputWrapper, { children: [jsxs(Header, { children: [label && jsx$1(Label$1, { label: label }, void 0), tooltip && jsx$1(Tooltip, { title: tooltip, placement: "bottom" }, void 0)] }, void 0), jsx$1(Component, Object.assign({}, props), void 0), validationErrors.map((validationError) => (jsx$1(ValidationError, { label: validationError }, void 0)))] }, void 0));
    };
    return Input;
};
...
export { DataTable, Dialog, Form, checkboxReducer, defaultQueryReducer, oDataQueryReducer, sortingReducer, useForm, withInput };
