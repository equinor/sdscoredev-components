...
const Body = forwardRef((props, ref) => {
    ...
    const generateRows = (items, depth = undefined) => {
        ...
        return items.map((item, index) => (jsxs(React__default.Fragment, { children: [createElement(Row$2, Object.assign({}, props, { depth: depth, data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` })), item.children && state.treeReducer.open.includes(item.id) && generateRows(item.children, depth)] }, index)));
    };
    if (!data)
        return jsx$1(Fragment, {}, void 0);
...
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        ...
        return (jsxs(InputWrapper, { children: [jsxs(Header, { children: [label && jsx$1(Label, { style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, label: label, meta: isRequired ? '*Required' : undefined }, void 0), tooltip && jsx$1(Tooltip, { title: tooltip, placement: "bottom" }, void 0)] }, void 0), jsx$1(Component, Object.assign({}, props), void 0), validationErrors ? validationErrors.map((validationError) => (jsx$1(ValidationError, { label: validationError }, void 0))) : jsx$1(Empty, {}, void 0)] }, void 0));
    };
    return Input;
};
