...
import React__default, { createContext, useReducer, useContext, useEffect, Children, forwardRef, useRef, createElement, useState, useImperativeHandle, cloneElement, Fragment as Fragment$1, useLayoutEffect, Component, useCallback, useMemo } from 'react';
...
const DataTableStore = (props) => {
    ...
    return (jsx$1(DispatchContext$1.Provider, Object.assign({ value: dispatch }, { children: jsx$1(StateContext$1.Provider, Object.assign({ value: state }, { children: jsxs(Fragment, { children: [children, plugins.map((plugin) => {
...
const HeaderCell = ({ column, onClick, id, width }) => {
    ...
    const sortIcon = () => {
        ...
        if (column.props.orderBy === sortingReducer.orderBy) {
            return jsx$1(Icon, { size: 18, name: sortingReducer.ascending ? 'chevron_up' : 'chevron_down' }, void 0);
        }
        else {
...
const Header$1 = ({ children, id }) => {
    ...
    if (!state.dataTableReducer.columns)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Head$1, { children: jsxs(Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsx$1(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsx$1(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))] }), void 0) }, void 0));
};
...
const Cell = (props) => {
    ...
    return (jsx$1(StyledCell, Object.assign({ slim: slim, truncate: truncate, scope: "col", id: id, onClick: () => onClick && onClick }, { children: href ? jsx$1("a", Object.assign({ href: href }, { children: RenderCell() }), void 0) : RenderCell() }), void 0));
};
...
const Row$2 = forwardRef((props, ref) => {
    ...
    return (jsxs(DefaultRow, Object.assign({ role: "row", ref: ref, style: getStyle && getStyle(data) }, { children: [state.checkboxReducer &&
                ...
                var _a;
                return (jsx$1(React__default.Fragment, { children: ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsx$1(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsx$1(Fragment, {}, void 0) }, `${column.props.id}-${data.id}`));
            })] }), void 0));
});
...
export { DataTable, Dialog, Form, checkboxReducer, columnSelectorReducer, defaultQueryReducer, oDataQueryReducer, paginationReducer, sortingReducer, stickyHeaderReducer, useForm, withInput };
