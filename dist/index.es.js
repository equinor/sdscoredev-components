import { Icon, Table, EdsProvider, Checkbox as Checkbox$2, Dialog as Dialog$1, Button as Button$1, DotProgress, Tooltip as Tooltip$1, Typography, NativeSelect, Pagination as Pagination$2, Label as Label$2, TextField as TextField$2 } from '@equinor/eds-core-react';
...
const Filter$1 = ({ title, onClick }) => {
    return (jsx$1(Tooltip$1, Object.assign({ title: "Show filter", placement: "top" }, { children: jsxs(Button$1, Object.assign({ variant: "ghost", onClick: onClick }, { children: [title, jsx$1(Icon, { name: "filter_list", title: "Show filter", size: 24 }, void 0)] }), void 0) }), void 0));
};
