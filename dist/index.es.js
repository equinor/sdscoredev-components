...
import React__default, { createContext, useReducer, useContext, useEffect, Children, forwardRef, createElement, useRef, useState, useImperativeHandle, cloneElement, Fragment as Fragment$1, useLayoutEffect, Component, useCallback, useMemo } from 'react';
...
const Row$2 = forwardRef((props, ref) => {
    ...
    return (jsxs(DefaultRow, Object.assign({ role: "row", ref: ref }, { children: [state.checkboxReducer &&
                jsx$1(CheckboxCell, { item: props.data }, "checkbox-header"), state.dataTableReducer.columns.map((column) => {
                var _a;
                if ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) {
                    return (createElement(Cell, Object.assign({}, props, { column: column, key: `${column.props.id}-${props.data.id}`, onClick: handleClick, item: props.data, href: props.getLink ? props.getLink(props.data) : undefined })));
                }
                return jsx$1(Fragment, {}, void 0);
            })] }), void 0));
});
...
const Body = forwardRef((props, ref) => {
    ...
    if (!data)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: data.map((item) => {
            return (createElement(Row$2, Object.assign({}, props, { key: `row-${item.id}`, data: item, ref: (el) => rowRef.current = el })));
        }) }), void 0));
});
