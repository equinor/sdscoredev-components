...
const CheckboxHeaderCell = () => {
    ...
    return (jsx$1(Cell$2, { children: jsx$1(EdsProvider, Object.assign({ density: "compact" }, { children: jsx$1(Wrapper$7, Object.assign({ onClick: selectAll }, { children: jsx$1(Checkbox, { name: "multiple", indeterminate: state.checkboxReducer.selected.length > 0 &&
...
const CheckboxCell = ({ item }) => {
    ...
    return (jsx$1(Cell$1, { children: jsx$1(EdsProvider, Object.assign({ density: "compact" }, { children: jsx$1(Wrapper$6, Object.assign({ onClick: select }, { children: jsx$1(Checkbox, { name: "multiple", checked: isSelected(), readOnly: true }, void 0) }), void 0) }), void 0) }, void 0));
};
...
const Body = forwardRef((props, ref) => {
    ...
    if (!data)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: data.map((item) => createElement(Row$2, Object.assign({}, props, { data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` }))) }), void 0));
});
