import { Icon, Table, EdsProvider, Checkbox as Checkbox$2, Dialog as Dialog$1, Button, DotProgress, Tooltip as Tooltip$1, Typography, NativeSelect, Pagination as Pagination$2, Label as Label$2, TextField as TextField$2 } from '@equinor/eds-core-react';
import { jsx as jsx$1, jsxs, Fragment } from 'react/jsx-runtime';
import * as React from 'react';
import React__default, { useEffect, useReducer, createContext, useContext, Children, forwardRef, useRef, createElement, useState, useImperativeHandle, cloneElement, Fragment as Fragment$1, useLayoutEffect, Component, useCallback, useMemo } from 'react';
import styled from 'styled-components';
import { useNavigate, useLocation } from 'react-router-dom';
import s from 'lodash.clonedeep';
import T from 'lodash.includes';
import x$1 from 'lodash.uniq';
import g$1 from 'lodash.isplainobject';
import k$1 from 'lodash.isdate';
...
const usePersistedReducer = (reducer, initialState, key, storage) => {
    const [state, dispatch] = React__default.useReducer(reducer, storage.get(key, initialState));
    useEffect(() => {
...
const DispatchContext$1 = createContext({});
const DataTableStore = React__default.memo((props) => {
     ...
     * @returns
     */
    const propReducers = () => Object.fromEntries(Object.entries(reducers).map(([name, reducer]) => [name, useReducer(reducer.reducer, reducer.initialState)]));
    ...
    return (jsx$1(DispatchContext$1.Provider, Object.assign({ value: dispatch }, { children: jsx$1(StateContext$1.Provider, Object.assign({ value: state }, { children: jsxs(Fragment, { children: [children, Object.entries(reducers).map((reducer, key) => {
                        const component = reducer[1].component;
                        if (component) {
                            return jsx$1(React__default.Fragment, { children: component({ state, dispatch }) }, key);
                        }
                        return jsx$1(React__default.Fragment, {}, key);
                    })] }, void 0) }), void 0) }), void 0));
});

const Cell$3 = styled(Table.Cell) `
...
const HeaderCell = ({ column, onClick, id, width }) => {
    ...
    const sortIcon = () => {
        ...
        if (column.props.orderBy === state.sortingReducer.orderBy || column.props.sort === state.sortingReducer.orderBy) {
            return jsx$1(Icon, { size: 18, name: state.sortingReducer.ascending ? 'chevron_up' : 'chevron_down' }, void 0);
        }
        else {
            return (jsxs(SortIcon, { children: [jsx$1(Icon, { size: 16, name: 'chevron_up', style: { position: 'absolute', top: '-12px' } }, void 0), jsx$1(Icon, { size: 16, name: 'chevron_down', style: { position: 'absolute', bottom: '-12px' } }, void 0)] }, void 0));
        }
    };
    return (jsxs(Cell$3, Object.assign({ onClick: onClick, id: id, className: "dataTableTh", width: width }, { children: [column.props.children, sortIcon()] }), void 0));
};

const Wrapper$8 = styled.div `
    cursor: pointer;
`;
const Cell$2 = styled(Table.Cell) `
    border-top: unset !important;
    /* width: 1%; */
    padding: 0 8px;
...
const CheckboxHeaderCell = () => {
    ...
    return (jsx$1(Cell$2, { children: jsx$1(EdsProvider, Object.assign({ density: "compact" }, { children: jsx$1(Wrapper$8, Object.assign({ onClick: selectAll }, { children: jsx$1(Checkbox$2, { name: "multiple", indeterminate: state.checkboxReducer.selected.length > 0 &&
...
const Head$1 = styled(Table.Head) `
    white-space: normal;
`;
const Header$1 = ({ children, id }) => {
    ...
    const dispatch = useContext(DispatchContext$1);
    useEffect(() => {
        const columns = Children.toArray(children).map((x) => {
            if (state.dataTableReducer.pluginColumnProps) {
                ...
                if (pluginProps) {
                    return (jsx$1(x.type, Object.assign({}, x.props, pluginProps), void 0));
                }
            }
            return x;
        });
    ...
    if (!state.dataTableReducer.columns)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Head$1, { children: jsxs(Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsx$1(CheckboxHeaderCell, {}, "checkbox-header")), state.columnSelectorReducer && ((_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsx$1(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props) }, column.props.id)))), !state.columnSelectorReducer && ((_b = state.dataTableReducer.columns) === null || _b === void 0 ? void 0 : _b.filter((x) => !x.props.optional).map((column) => (jsx$1(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id))))] }), void 0) }, void 0));
};

const Wrapper$7 = styled.div `
    cursor: pointer;
`;
const Cell$1 = styled(Table.Cell) `
    border-top: unset !important;
    width: 1%;
    padding: 0 8px;
...
const CheckboxCell = ({ item }) => {
    ...
    return (jsx$1(Cell$1, { children: jsx$1(EdsProvider, Object.assign({ density: "compact" }, { children: jsx$1(Wrapper$7, Object.assign({ onClick: select }, { children: jsx$1(Checkbox$2, { name: "multiple", checked: isSelected(), readOnly: true }, void 0) }), void 0) }), void 0) }, void 0));
};
...
const Cell = (props) => {
    ...
    const RenderCell = () => {
        ...
        if (!render && truncate) {
            return (jsx$1("div", Object.assign({ className: "truncated-cell" }, { children: jsxs("span", { children: [resolve(item, id, ''), jsx$1("div", {}, void 0)] }, void 0) }), void 0));
        }
        /* Default render */
        return resolve(item, id, '');
    };
    return (jsx$1(StyledCell, Object.assign({ slim: slim, truncate: truncate, scope: "col", id: id, onClick: () => onClick && onClick }, { children: href ? jsx$1("a", Object.assign({ className: "row-link", href: href, onClick: (e) => {
                e.preventDefault();
...
`;
const Row$2 = forwardRef((props, ref) => {
    ...
    if (!data || !state.dataTableReducer.columns)
        return jsx$1(Fragment, {}, void 0);
    return (jsxs(DefaultRow, Object.assign({ role: "row", ref: ref, style: getStyle && getStyle(data) }, { children: [state.checkboxReducer &&
                jsx$1(CheckboxCell, { item: data }, `checkbox-header-${data.id}`), state.dataTableReducer.columns.map((column) => {
                var _a;
                return (jsxs(React__default.Fragment, { children: [state.columnSelectorReducer && ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsx$1(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsx$1(Fragment, {}, void 0), !state.columnSelectorReducer && !column.props.optional ? (jsx$1(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsx$1(Fragment, {}, void 0)] }, `${column.props.id}-${data.id}`));
            })] }), void 0));
});
...
const Body = forwardRef((props, ref) => {
    ...
    const generateRows = (items, depth = undefined) => {
        ...
        return items.map((item, index) => (jsxs(React__default.Fragment, { children: [createElement(Row$2, Object.assign({}, props, { depth: depth, data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` })), item.children && state.treeReducer && state.treeReducer.open.includes(item.id) && generateRows(item.children, depth)] }, index)));
    };
    if (!data)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: generateRows(data) }), void 0));
});
...
const ButtonWrapper = styled.div `
    ...
    grid-gap: 8px;
`;
const StyledEdsDialog = styled(Dialog$1) `
    width: 85vw;
...
const Dialog = forwardRef((props, ref) => {
    ...
    if (!isOpen)
        return jsx$1(Fragment, {}, void 0);
    return (jsxs(StyledEdsDialog, Object.assign({ "data-cy": "dialog", width: width || 0, open: isOpen }, { children: [jsx$1(Dialog$1.Header, { children: jsx$1(Dialog$1.Title, { children: title }, void 0) }, void 0), jsx$1(Dialog$1.CustomContent, Object.assign({ style: style, scrollable: false }, { children: children }), void 0), jsx$1(Dialog$1.Actions, { children: jsxs(ButtonWrapper, { children: [primaryButton && (jsx$1(Button, Object.assign({ color: "primary", variant: "contained", onClick: handlePrimary, "data-cy": "dialog-close" }, { children: !noLoading && isLoading ? jsx$1(DotProgress, {}, void 0) : primaryButton }), void 0)), dangerButton && (jsx$1(Button, Object.assign({ color: "danger", variant: "contained", onClick: onDanger, "data-cy": "dialog-danger" }, { children: dangerButton }), void 0)), cancelButton && (jsx$1(Button, Object.assign({ variant: "ghost", onClick: handleCancel, "data-cy": "dialog-cancel" }, { children: cancelButton }), void 0))] }, void 0) }, void 0)] }), void 0));
});
...
const ColumnSelector$1 = forwardRef((props, ref) => {
    ...
    if (!state.dataTableReducer.columns.length)
        return jsx$1(Fragment, {}, void 0);
    return (jsxs(Fragment, { children: [jsx$1(Tooltip$1, Object.assign({ title: "Manage columns", placement: "top" }, { children: jsxs(Button, Object.assign({ variant: "ghost", onClick: () => { var _a; return (_a = dialogRef === null || dialogRef === void 0 ? void 0 : dialogRef.current) === null || _a === void 0 ? void 0 : _a.open(); } }, { children: [title, icon] }), void 0) }), void 0), jsxs(Dialog, Object.assign({ title: title, width: 800, primaryButton: "Reset", cancelButton: "Close", noLoading: true, onPrimary: handleResetColumns, ref: dialogRef }, { children: [jsx$1(Typography, Object.assign({ variant: "h6" }, { children: "Default columns" }), void 0), jsx$1(OptionsWrapper, { children: state.dataTableReducer.columns.filter((x) => !x.props.optional && !x.props.id.startsWith('__')).map((column) => {
                            var _a;
                            return (jsx$1(Checkbox$2, { label: column.props.children, checked: (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id), onChange: () => handleChange(column) }, column.props.id));
                        }) }, void 0), jsx$1(Typography, Object.assign({ variant: "h6" }, { children: "Optional columns" }), void 0), jsx$1(OptionsWrapper, { children: state.dataTableReducer.columns.filter((x) => x.props.optional && !x.props.id.startsWith('__')).map((column) => {
                            var _a;
                            return (jsx$1(Checkbox$2, { label: column.props.children, checked: (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id), onChange: () => handleChange(column) }, column.props.id));
                        }) }, void 0)] }), void 0)] }, void 0));
});
...
const Pagination$1 = ({ count, defaultPageSize }) => {
    ...
    if (!pageSize)
        return jsx$1(Fragment, {}, void 0);
    return (jsxs(Wrapper$6, { children: [jsx$1(NativeSelect, Object.assign({ id: "", label: "", value: +pageSize, onChange: handleChangePageSize }, { children: pageSizeOptions.map((pageSize) => jsxs("option", Object.assign({ value: pageSize }, { children: [pageSize, " / page"] }), `pageSize-${pageSize}`)) }), `pageSize-${+pageSize}`), jsx$1(Pagination$2, { totalItems: count || 0, itemsPerPage: +pageSize, defaultPage: +pageIndex, withItemIndicator: true, 
                // @ts-ignore
...
const Filter$1 = ({ title, onClick }) => {
    return (jsx$1(Tooltip$1, Object.assign({ title: "Show filter", placement: "top" }, { children: jsxs(Button, Object.assign({ variant: "ghost", onClick: onClick }, { children: [title, jsx$1(Icon, { name: "filter_list", title: "Show filter", size: 24 }, void 0)] }), void 0) }), void 0));
};
...
const Toolbar$1 = ({ children, components }) => {
    useContext(DispatchContext$1);
    return (jsxs(Wrapper$5, { children: [jsx$1(Left, { children: components && components.filter((x) => x.props.placement === 'left' || !x.props.placement).map((component, index) => (jsx$1(React__default.Fragment, { children: component.props.children }, `lt-${index}`))) }, void 0), jsxs(Right, { children: [children, components && components.filter((x) => x.props.placement === 'right').map((component, index) => (jsx$1(RightInner, { children: component.props.children }, `rt-${index}`)))] }, void 0)] }, void 0));
};
...
const StickyTable = styled(Table) `
    ...
    z-index: 9;
`;
const StickyHeader$1 = forwardRef((props, ref) => {
    var _a;
    ...
    if (!state.stickyHeaderReducer.width)
        return jsx$1(Fragment, {}, void 0);
    return (jsx$1(StickyTable, Object.assign({ stick: stick, threshold: threshold }, { children: jsx$1(Head, Object.assign({ id: `dataTable.stickyHeaderRow.${id}` }, { children: jsxs(Table.Row, { children: [state.checkboxReducer && (jsx$1(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsx$1(HeaderCell, { width: state.stickyHeaderReducer.width[column.props.id], id: `sticky-${column.props.id}`, column: column, onClick: () => handleClick(column.props) }, column.props.id)))] }, void 0) }), void 0) }), void 0));
});

Icon.add({ chevron_down, chevron_right });
const Wrapper$4 = styled.span `
    display: grid;
...
const TreeCellRender = (props) => {
    ...
    return (jsx$1(EdsProvider, Object.assign({ density: "compact" }, { children: jsxs(Wrapper$4, Object.assign({ depth: depth || 0 }, { children: [jsx$1("div", {}, void 0), item.children ? (jsx$1(Button, Object.assign({ variant: "ghost_icon", onClick: handleClick }, { children: jsx$1(Icon, { name: isOpen() ? 'chevron_down' : 'chevron_right', size: 24, style: { color: "#007079" } }, void 0) }), void 0)) : jsx$1("div", {}, void 0), jsx$1("span", Object.assign({ style: { display: 'inline-block', alignSelf: 'center', paddingLeft: '4px' } }, { children: content }), void 0)] }), void 0) }), void 0));
};
...
`;
const DataTable$1 = React__default.memo((props) => {
...
const ColumnSelector = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "ColumnSelector" }), void 0));
};
ColumnSelector.reducer = { columnSelectorReducer };

const Export = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "Export" }), void 0));
};

const Column = ({ children }) => {
    return (jsx$1(Table.Cell, { children: children }, void 0));
};
...
const Pagination = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "Pagination" }), void 0));
};
...
const Tree = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "Tree" }), void 0));
};
 ...
 */
const Toolbar = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "Toolbar" }), void 0));
};
...
const StickyHeader = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "StickyHeader" }), void 0));
};
StickyHeader.reducer = { stickyHeaderReducer };

const DefaultQuery$1 = () => {
    return (jsx$1(React__default.Fragment, { children: "DefaultQuery" }, void 0));
};
...
const Checkbox = (props) => {
    return (jsx$1(React__default.Fragment, Object.assign({}, props, { children: "Checkbox" }), void 0));
};
 ...
 */
function l$1(e){return e==null?!1:Array.isArray(e)||typeof e=="string"?!!e.length:g$1(e)?!!Object.keys(e).length:typeof e=="number"}
...
const FormStore = (props) => {
    ...
    Object.fromEntries(Object.entries(reducers).map(([name, reducer]) => [name, useReducer(reducer.reducer, reducer.initialState)])));
    return (jsx$1(DispatchContext.Provider, Object.assign({ value: dispatch }, { children: jsx$1(StateContext.Provider, Object.assign({ value: state }, { children: jsxs(Fragment, { children: [children, plugins.map((plugin) => {
                        return jsx$1(React__default.Fragment, { children: plugin({ state, dispatch }) }, plugin.name);
                    })] }, void 0) }), void 0) }), void 0));
};
...
const Form$1 = forwardRef((props, ref) => {
    ...
    return (jsxs(FormStore, Object.assign({ reducers: Object.assign({ formReducer,
            validationReducer }, reducers) }, { children: [validation && jsx$1(Validation$1, Object.assign({}, validation.props), void 0), jsx$1(ColumnsWrapper, Object.assign({ count: children.length }, { children: jsx$1(FormWrapper, Object.assign({}, props, { children: inputFields }), void 0) }), void 0)] }), void 0));
});
...
const Row = (props) => {
    ...
    const gap = 20;
    const children = Children.toArray(props.children);
    return (jsx$1(Wrapper$2, Object.assign({ count: children.length, gap: gap, width: 300 }, { children: Children.map(children, (child, index) => {
            if (fixed) {
                return (jsx$1(FixedInner$1, Object.assign({ fixed: fixed, count: children.length, gap: gap }, { children: cloneElement(child, {}) }), void 0));
            }
            else {
                return (jsx$1(DynamicInner$1, Object.assign({ count: children.length, gap: gap }, { children: cloneElement(child, {}) }), void 0));
            }
        }) }), void 0));
};

const Wrapper$1 = styled.span `
    display: inline-flex;
    width: 100%;
...
const Label$1 = (props) => {
    ...
    return (jsxs(Wrapper$1, { children: [jsx$1(Item, { children: children }, void 0), meta && (jsx$1(Item, { children: meta }, void 0))] }, void 0));
};
...
const Actions = (props) => {
    ...
    const gap = 10;
    const children = Children.toArray(props.children);
    return (jsx$1(Wrapper, Object.assign({ count: children.length, gap: gap }, { children: Children.map(children, (child, index) => {
            if (fixed) {
                return (jsx$1(FixedInner, Object.assign({ fixed: fixed, count: children.length, gap: gap }, { children: cloneElement(child, {}) }), void 0));
            }
            else {
                return (jsx$1(DynamicInner, Object.assign({ count: children.length, gap: gap }, { children: cloneElement(child, {}) }), void 0));
            }
        }) }), void 0));
};

Icon.add({ help_outline });
const StyledEdsTooltip = styled(Tooltip$1) `
    &:hover {
        cursor: help;
    }
...
const Tooltip = (props) => {
    ...
    return (jsx$1(Fragment, { children: !disabled ? (jsx$1(StyledEdsTooltip, Object.assign({ className: className, title: title, open: open, placement: placement, maxWidth: maxWidth }, { children: children || (jsx$1(StyledIcon, { name: "help_outline", size: 16, color: "#007079" }, void 0)) }), void 0)) : (jsx$1(Fragment, { children: children }, void 0)) }, void 0));
};

const ReadOnly = (props) => {
    const { render, value, childKey } = props;
    if (render) {
        return jsx$1(Fragment, { children: render({ options: value, getTagProps: () => { }, childKey }) }, void 0);
    }
    if (typeof value === 'object' && childKey) {
        return jsx$1(Fragment, { children: value[childKey] }, void 0);
    }
    return jsx$1(Fragment, { children: value }, void 0);
};
...
const Header = styled.div `
    ...
    white-space: nowrap;
`;
const ValidationError = styled(Label$2) `
    color: rgb(235, 0, 0);
    margin-top: 4px;
    height: 16px;
`;
const Label = styled(Label$2) `
    height: 16px;
...
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        ...
        return (jsxs(InputWrapper, { children: [jsxs(Header, { children: [label && jsx$1(Label, { style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, label: label }, void 0), tooltip && jsx$1(Tooltip, { title: tooltip, placement: "bottom" }, void 0), isRequired && jsx$1(Label, { label: '', style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, meta: '*Required' }, void 0)] }, void 0), edit ? jsx$1(Component, Object.assign({}, props), void 0) : jsx$1(ReadOnly, Object.assign({}, props), void 0), validationErrors ? validationErrors.map((validationError) => (jsx$1(ValidationError, { label: validationError }, void 0))) : jsx$1(Empty, {}, void 0)] }, void 0));
    };
    return Input;
};
...
const TextField = (props) => {
    ...
    return (jsx$1(TextField$2, { id: id, meta: meta, value: value || '', onChange: onChange, variant: error ? "error" : "default", helperText: error, helperIcon: error && jsx$1(Icon, { name: "error_filled", title: "Error" }, void 0), disabled: disabled }, void 0));
};
...
var LiveRegion = function LiveRegion(props) {
  ...
  return jsx(Fragment$1, null, jsx(A11yText, {
    id: id
...
const SelectField = (props) => {
    ...
    return (jsx$1(Select, { id: id, options: options, getOptionLabel: (option) => option.name, getOptionValue: (option) => option.id, value: options ? options.filter((x) => x.id === value) : {}, onChange: handleChange, 
        // placeholder={placeholder}
        isDisabled: isDisabled, 
...
export { DataTable, Dialog, Form, Tooltip, checkboxReducer, columnSelectorReducer, defaultQueryReducer, oDataQueryReducer, paginationReducer, sortingReducer, stickyHeaderReducer, useForm, withInput };
