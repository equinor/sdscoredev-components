...
const Row$2 = forwardRef((props, ref) => {
    ...
    if (!props.data || !state.dataTableReducer.columns)
        return jsx$1(Fragment, {}, void 0);
    return (jsxs(DefaultRow, Object.assign({ role: "row", ref: ref }, { children: [state.checkboxReducer &&
                jsx$1(CheckboxCell, { item: props.data }, `checkbox-header-${props.data.id}`), state.dataTableReducer.columns.map((column) => {
                var _a;
                return (jsx$1(React__default.Fragment, { children: ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsx$1(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: props.data, href: props.getLink ? props.getLink(props.data) : undefined }), void 0)) : jsx$1(Fragment, {}, void 0) }, `${column.props.id}-${props.data.id}`));
            })] }), void 0));
});
...
const Toolbar$1 = ({ children }) => {
    ...
    return (jsxs(Wrapper$4, { children: [jsx$1(Left, {}, void 0), jsx$1(Right, { children: children }, void 0)] }, void 0));
};
