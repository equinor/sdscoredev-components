...
const DataTableStore = (props) => {
    ...
    return (jsxRuntime.jsx(DispatchContext$1.Provider, Object.assign({ value: dispatch }, { children: jsxRuntime.jsx(StateContext$1.Provider, Object.assign({ value: state }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [children, plugins.map((plugin) => {
...
const HeaderCell = ({ column, onClick, id, width }) => {
    ...
    const sortIcon = () => {
        if (!sortingReducer || !column.props.orderBy)
            return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
        if (column.props.orderBy === sortingReducer.orderBy) {
            return jsxRuntime.jsx(edsCoreReact.Icon, { size: 18, name: sortingReducer.ascending ? 'chevron_up' : 'chevron_down' }, void 0);
        }
        else {
...
const Header$1 = ({ children, id }) => {
    ...
    if (!state.dataTableReducer.columns)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(Head$1, { children: jsxRuntime.jsxs(edsCoreReact.Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsxRuntime.jsx(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsxRuntime.jsx(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))] }), void 0) }, void 0));
};
...
const Cell = (props) => {
    ...
    return (jsxRuntime.jsx(StyledCell, Object.assign({ slim: slim, truncate: truncate, scope: "col", id: id, onClick: () => onClick && onClick }, { children: href ? jsxRuntime.jsx("a", Object.assign({ href: href }, { children: RenderCell() }), void 0) : RenderCell() }), void 0));
};
...
const Row$2 = React.forwardRef((props, ref) => {
    ...
    return (jsxRuntime.jsxs(DefaultRow, Object.assign({ role: "row", ref: ref, style: getStyle && getStyle(data) }, { children: [state.checkboxReducer &&
                ...
                var _a;
                return (jsxRuntime.jsx(React__default["default"].Fragment, { children: ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsxRuntime.jsx(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0) }, `${column.props.id}-${data.id}`));
            })] }), void 0));
});
...
`;
const DataTable$1 = React.forwardRef((props, ref) => {
...
const oDataQueryReducer = { reducer: reducer$4, initialState: initialState$4, component };
...
const sortingReducer = { reducer: reducer$3, initialState: initialState$3 };
...
const stickyHeaderReducer = { reducer: reducer$2, initialState: initialState$2 };
