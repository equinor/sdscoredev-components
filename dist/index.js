...
const Row$2 = React.forwardRef((props, ref) => {
    ...
    return (jsxRuntime.jsxs(DefaultRow, Object.assign({ role: "row", ref: ref }, { children: [state.checkboxReducer &&
                jsxRuntime.jsx(CheckboxCell, { item: props.data }, "checkbox-header"), state.dataTableReducer.columns.map((column) => {
                var _a;
                if ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) {
                    return (React.createElement(Cell, Object.assign({}, props, { column: column, key: `${column.props.id}-${props.data.id}`, onClick: handleClick, item: props.data, href: props.getLink ? props.getLink(props.data) : undefined })));
                }
                return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
            })] }), void 0));
});
...
const Body = React.forwardRef((props, ref) => {
    ...
    if (!data)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(edsCoreReact.Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: data.map((item) => {
            return (React.createElement(Row$2, Object.assign({}, props, { key: `row-${item.id}`, data: item, ref: (el) => rowRef.current = el })));
        }) }), void 0));
});
