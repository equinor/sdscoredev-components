...
const CheckboxHeaderCell = () => {
    ...
    return (jsxRuntime.jsx(Cell$2, { children: jsxRuntime.jsx(edsCoreReact.EdsProvider, Object.assign({ density: "compact" }, { children: jsxRuntime.jsx(Wrapper$7, Object.assign({ onClick: selectAll }, { children: jsxRuntime.jsx(edsCoreReact.Checkbox, { name: "multiple", indeterminate: state.checkboxReducer.selected.length > 0 &&
...
const Header$1 = ({ children, id }) => {
    ...
    const dispatch = React.useContext(DispatchContext$1);
    React.useEffect(() => {
        dispatch({ type: 'SET_COLUMNS', payload: React.Children.toArray(children) });
    }, []);
...
const CheckboxCell = ({ item }) => {
    ...
    return (jsxRuntime.jsx(Cell$1, { children: jsxRuntime.jsx(edsCoreReact.EdsProvider, Object.assign({ density: "compact" }, { children: jsxRuntime.jsx(Wrapper$6, Object.assign({ onClick: select }, { children: jsxRuntime.jsx(edsCoreReact.Checkbox, { name: "multiple", checked: isSelected(), readOnly: true }, void 0) }), void 0) }), void 0) }, void 0));
};
...
const Body = React.forwardRef((props, ref) => {
    ...
    if (!data)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(edsCoreReact.Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: data.map((item) => React.createElement(Row$2, Object.assign({}, props, { data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` }))) }), void 0));
});
...
const Toolbar$1 = ({ children, components }) => {
    ...
    return (jsxRuntime.jsxs(Wrapper$4, { children: [jsxRuntime.jsx(Left, { children: components && components.filter((x) => x.props.placement === 'left' || !x.props.placement).map((component, index) => (jsxRuntime.jsx(React__default["default"].Fragment, { children: component.props.children }, `lt-${index}`))) }, void 0), jsxRuntime.jsxs(Right, { children: [children, components && components.filter((x) => x.props.placement === 'right').map((component, index) => (jsxRuntime.jsx(RightInner, { children: component.props.children }, `rt-${index}`)))] }, void 0)] }, void 0));
};
