...
const HeaderCell = ({ column, onClick, id, width }) => {
    ...
    const sortIcon = () => {
        if (!state.sortingReducer || !column.props.orderBy)
...
const Header$1 = ({ children, id }) => {
    ...
    const handleClick = (orderBy) => {
        dispatch({ type: 'SORT', payload: orderBy });
    };
    if (!state.dataTableReducer.columns)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(Head$1, { children: jsxRuntime.jsxs(edsCoreReact.Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsxRuntime.jsx(CheckboxHeaderCell, {}, "checkbox-header")), state.columnSelectorReducer && ((_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsxRuntime.jsx(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))), !state.columnSelectorReducer && ((_b = state.dataTableReducer.columns) === null || _b === void 0 ? void 0 : _b.filter((x) => !x.props.optional).map((column) => (jsxRuntime.jsx(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id))))] }), void 0) }, void 0));
};
...
const StickyHeader$1 = React.forwardRef((props, ref) => {
    ...
    if (!state.stickyHeaderReducer.width)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(StickyTable, Object.assign({ stick: stick, threshold: threshold }, { children: jsxRuntime.jsx(Head, Object.assign({ id: `dataTable.stickyHeaderRow.${id}` }, { children: jsxRuntime.jsxs(edsCoreReact.Table.Row, { children: [state.checkboxReducer && (jsxRuntime.jsx(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsxRuntime.jsx(HeaderCell, { width: state.stickyHeaderReducer.width[column.props.id], id: `sticky-${column.props.id}`, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id)))] }, void 0) }), void 0) }), void 0));
});
...
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        ...
        return (jsxRuntime.jsxs(InputWrapper, { children: [jsxRuntime.jsxs(Header, { children: [label && jsxRuntime.jsx(edsCoreReact.Label, { label: label }, void 0), tooltip && jsxRuntime.jsx(Tooltip, { title: tooltip, placement: "bottom" }, void 0)] }, void 0), jsxRuntime.jsx(Component, Object.assign({}, props), void 0), validationErrors.map((validationError) => (jsxRuntime.jsx(ValidationError, { label: validationError }, void 0)))] }, void 0));
    };
    return Input;
};
