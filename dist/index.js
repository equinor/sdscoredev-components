...
var s = require('lodash.clonedeep');
var T = require('lodash.includes');
var x$1 = require('lodash.uniq');
var g$1 = require('lodash.isplainobject');
var k$1 = require('lodash.isdate');
var M = require('lodash.isfinite');
...
var x__default = /*#__PURE__*/_interopDefaultLegacy(x$1);
var g__default = /*#__PURE__*/_interopDefaultLegacy(g$1);
var k__default = /*#__PURE__*/_interopDefaultLegacy(k$1);
...
const addIcons = () => {
    edsCoreReact.Icon.add(icons);
};

const useCombinedReducers = (combinedReducers) => {
    const state = Object.keys(combinedReducers).reduce((acc, key) => (Object.assign(Object.assign({}, acc), { [key]: combinedReducers[key][0] })), {});
    const dispatch = (action) => Object.keys(combinedReducers)
        .map(key => combinedReducers[key][1])
        .forEach(fn => fn(action));
    return [state, dispatch];
};
const resolve = (object, path, defaultValue = {}) => path === null || path === void 0 ? void 0 : path.split('.').reduce((o, p) => (o ? o[p] : defaultValue), object);
const makeId = () => {
    let id = "";
...
const usePersistedReducer = (reducer, initialState, key, storage) => {
    const [state, dispatch] = React__default["default"].useReducer(reducer, storage.get(key, initialState));
    React.useEffect(() => {
...
const StateContext$1 = React.createContext({});
const DispatchContext$1 = React.createContext({});
const DataTableStore = React__default["default"].memo((props) => {
    ...
    const persistedComponentReducers = () => Object.fromEntries(components
        .filter((component) => component.type.reducer && component.props['cacheKey'])
        .map((component) => {
        if (!component.type.reducer)
            return [];
        const [name, reducer] = Object.entries(component.type.reducer)[0];
    ...
    const componentReducers = () => Object.fromEntries(components
        ...
        if (!component.type.reducer)
            return [];
        const [name, reducer] = Object.entries(component.type.reducer)[0];
        return [name, React.useReducer(reducer.reducer, reducer.initialState)];
    }));
    /**
     ...
     * @returns
     */
    const propReducers = () => Object.fromEntries(Object.entries(reducers).map(([name, reducer]) => [name, React.useReducer(reducer.reducer, reducer.initialState)]));
    const [state, dispatch] = useCombinedReducers(Object.assign(Object.assign(Object.assign({}, propReducers()), persistedComponentReducers()), componentReducers()));
    return (jsxRuntime.jsx(DispatchContext$1.Provider, Object.assign({ value: dispatch }, { children: jsxRuntime.jsx(StateContext$1.Provider, Object.assign({ value: state }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [children, Object.entries(reducers).map((reducer, key) => {
                        const component = reducer[1].component;
                        if (component) {
                            return jsxRuntime.jsx(React__default["default"].Fragment, { children: component({ state, dispatch }) }, key);
                        }
                        return jsxRuntime.jsx(React__default["default"].Fragment, {}, key);
                    })] }, void 0) }), void 0) }), void 0));
});

const Cell$3 = styled__default["default"](edsCoreReact.Table.Cell) `
...
`;
const SortIcon = styled__default["default"].div `
    position: relative;
`;
const HeaderCell = ({ column, onClick, id, width }) => {
    const state = React.useContext(StateContext$1);
    const sortIcon = () => {
        // TODO: Remove orderBy, its deprecated
        if (!state.sortingReducer || (!column.props.orderBy && !column.props.sort))
        ...
        if (column.props.orderBy === state.sortingReducer.orderBy || column.props.sort === state.sortingReducer.orderBy) {
            return jsxRuntime.jsx(edsCoreReact.Icon, { size: 18, name: state.sortingReducer.ascending ? 'chevron_up' : 'chevron_down' }, void 0);
        }
        else {
            return (jsxRuntime.jsxs(SortIcon, { children: [jsxRuntime.jsx(edsCoreReact.Icon, { size: 16, name: 'chevron_up', style: { position: 'absolute', top: '-12px' } }, void 0), jsxRuntime.jsx(edsCoreReact.Icon, { size: 16, name: 'chevron_down', style: { position: 'absolute', bottom: '-12px' } }, void 0)] }, void 0));
        }
    };
    return (jsxRuntime.jsxs(Cell$3, Object.assign({ onClick: onClick, id: id, className: "dataTableTh", width: width }, { children: [column.props.children, sortIcon()] }), void 0));
};

const Wrapper$8 = styled__default["default"].div `
    cursor: pointer;
`;
const Cell$2 = styled__default["default"](edsCoreReact.Table.Cell) `
    border-top: unset !important;
    /* width: 1%; */
    padding: 0 8px;
...
const CheckboxHeaderCell = () => {
    ...
    return (jsxRuntime.jsx(Cell$2, { children: jsxRuntime.jsx(edsCoreReact.EdsProvider, Object.assign({ density: "compact" }, { children: jsxRuntime.jsx(Wrapper$8, Object.assign({ onClick: selectAll }, { children: jsxRuntime.jsx(edsCoreReact.Checkbox, { name: "multiple", indeterminate: state.checkboxReducer.selected.length > 0 &&
                        state.checkboxReducer.selected.length < state.dataTableReducer.data.length, checked: state.checkboxReducer.selected.length > 0 &&
                        state.checkboxReducer.selected.length === state.dataTableReducer.data.length, readOnly: true, style: { width: '1%' } }, void 0) }), void 0) }), void 0) }, void 0));
};

const Head$1 = styled__default["default"](edsCoreReact.Table.Head) `
    white-space: normal;
`;
const Header$1 = ({ children, id }) => {
    var _a, _b;
    const state = React.useContext(StateContext$1);
    const dispatch = React.useContext(DispatchContext$1);
    React.useEffect(() => {
        const columns = React.Children.toArray(children).map((x) => {
            if (state.dataTableReducer.pluginColumnProps) {
                ...
                if (pluginProps) {
                    return (jsxRuntime.jsx(x.type, Object.assign({}, x.props, pluginProps), void 0));
                }
            }
            return x;
        });
    ...
    if (!state.dataTableReducer.columns)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(Head$1, { children: jsxRuntime.jsxs(edsCoreReact.Table.Row, Object.assign({ id: `dataTable.headerRow.${id}` }, { children: [state.checkboxReducer && (jsxRuntime.jsx(CheckboxHeaderCell, {}, "checkbox-header")), state.columnSelectorReducer && ((_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsxRuntime.jsx(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props) }, column.props.id)))), !state.columnSelectorReducer && ((_b = state.dataTableReducer.columns) === null || _b === void 0 ? void 0 : _b.filter((x) => !x.props.optional).map((column) => (jsxRuntime.jsx(HeaderCell, { id: column.props.id, column: column, onClick: () => handleClick(column.props.orderBy) }, column.props.id))))] }), void 0) }, void 0));
};

const Wrapper$7 = styled__default["default"].div `
    cursor: pointer;
`;
const Cell$1 = styled__default["default"](edsCoreReact.Table.Cell) `
    border-top: unset !important;
    width: 1%;
    padding: 0 8px;
...
const CheckboxCell = ({ item }) => {
    ...
    const select = () => {
        var _a;
        const index = (_a = state.checkboxReducer.selected) === null || _a === void 0 ? void 0 : _a.findIndex((x) => x.id === item.id);
    ...
    const isSelected = () => state.checkboxReducer.selected && state.checkboxReducer.selected.findIndex((x) => x.id === item.id) !== -1;
    return (jsxRuntime.jsx(Cell$1, { children: jsxRuntime.jsx(edsCoreReact.EdsProvider, Object.assign({ density: "compact" }, { children: jsxRuntime.jsx(Wrapper$7, Object.assign({ onClick: select }, { children: jsxRuntime.jsx(edsCoreReact.Checkbox, { name: "multiple", checked: isSelected(), readOnly: true }, void 0) }), void 0) }), void 0) }, void 0));
};

const StyledCell = styled__default["default"](edsCoreReact.Table.Cell) `
    border-top: unset !important;
    background-image: linear-gradient(to bottom, #cfcfcf, transparent 50%);
    background-position: right top, right bottom;
    background-repeat: repeat-y;
    ...
    width: ${(props) => (props.slim ? '1%' : 'unset')};
    max-width: ${(props) => (props.truncate ? `${props.truncate}px` : 'unset')};
...
const Cell = (props) => {
    ...
    React.useContext(StateContext$1);
    const RenderCell = () => {
        ...
        if (render && Array.isArray(render)) {
            return render[0](Object.assign(Object.assign({}, props), { content: resolve(item, id, ''), renderProps: render[1] }));
        }
        if (!render && truncate) {
            return (jsxRuntime.jsx("div", Object.assign({ className: "truncated-cell" }, { children: jsxRuntime.jsxs("span", { children: [resolve(item, id, ''), jsxRuntime.jsx("div", {}, void 0)] }, void 0) }), void 0));
        }
        /* Default render */
        return resolve(item, id, '');
    };
    return (jsxRuntime.jsx(StyledCell, Object.assign({ slim: slim, truncate: truncate, scope: "col", id: id, onClick: () => onClick && onClick }, { children: href ? jsxRuntime.jsx("a", Object.assign({ className: "row-link", href: href, onClick: (e) => {
                e.preventDefault();
                window.location.replace(href);
            } }, { children: RenderCell() }), void 0) : RenderCell() }), void 0));
};

const DefaultRow = styled__default["default"](edsCoreReact.Table.Row) `
    display: table-row;
...
`;
const Row$2 = React.forwardRef((props, ref) => {
    ...
    if (!data || !state.dataTableReducer.columns)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsxs(DefaultRow, Object.assign({ role: "row", ref: ref, style: getStyle && getStyle(data) }, { children: [state.checkboxReducer &&
                jsxRuntime.jsx(CheckboxCell, { item: data }, `checkbox-header-${data.id}`), state.dataTableReducer.columns.map((column) => {
                var _a;
                return (jsxRuntime.jsxs(React__default["default"].Fragment, { children: [state.columnSelectorReducer && ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsxRuntime.jsx(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0), !state.columnSelectorReducer && !column.props.optional ? (jsxRuntime.jsx(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: data, href: getLink ? getLink(data) : undefined }), void 0)) : jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0)] }, `${column.props.id}-${data.id}`));
            })] }), void 0));
});
...
const Body = React.forwardRef((props, ref) => {
     ...
     */
    const generateRows = (items, depth = undefined) => {
        typeof depth == 'number' ? depth++ : depth = 0;
        return items.map((item, index) => (jsxRuntime.jsxs(React__default["default"].Fragment, { children: [React.createElement(Row$2, Object.assign({}, props, { depth: depth, data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` })), item.children && state.treeReducer && state.treeReducer.open.includes(item.id) && generateRows(item.children, depth)] }, index)));
    };
    if (!data)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(edsCoreReact.Table.Body, Object.assign({ ref: ref, id: `dataTable.body.${id}` }, { children: generateRows(data) }), void 0));
});
...
const ButtonWrapper = styled__default["default"].div `
    ...
    grid-gap: 8px;
`;
const StyledEdsDialog = styled__default["default"](edsCoreReact.Dialog) `
    width: 85vw;
    max-width: ${(props) => props.width ? `${props.width}px` : '600px'};
`;
const Dialog = React.forwardRef((props, ref) => {
    const { children, title, onCancel, onPrimary, onDanger, cancelButton, primaryButton, dangerButton, width, noLoading = false, style } = props;
    ...
    if (!isOpen)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsxs(StyledEdsDialog, Object.assign({ "data-cy": "dialog", width: width || 0, open: isOpen }, { children: [jsxRuntime.jsx(edsCoreReact.Dialog.Header, { children: jsxRuntime.jsx(edsCoreReact.Dialog.Title, { children: title }, void 0) }, void 0), jsxRuntime.jsx(edsCoreReact.Dialog.CustomContent, Object.assign({ style: style, scrollable: false }, { children: children }), void 0), jsxRuntime.jsx(edsCoreReact.Dialog.Actions, { children: jsxRuntime.jsxs(ButtonWrapper, { children: [primaryButton && (jsxRuntime.jsx(edsCoreReact.Button, Object.assign({ color: "primary", variant: "contained", onClick: handlePrimary, "data-cy": "dialog-close" }, { children: !noLoading && isLoading ? jsxRuntime.jsx(edsCoreReact.DotProgress, {}, void 0) : primaryButton }), void 0)), dangerButton && (jsxRuntime.jsx(edsCoreReact.Button, Object.assign({ color: "danger", variant: "contained", onClick: onDanger, "data-cy": "dialog-danger" }, { children: dangerButton }), void 0)), cancelButton && (jsxRuntime.jsx(edsCoreReact.Button, Object.assign({ variant: "ghost", onClick: handleCancel, "data-cy": "dialog-cancel" }, { children: cancelButton }), void 0))] }, void 0) }, void 0)] }), void 0));
});
...
const OptionsWrapper = styled__default["default"].div `
    ...
    margin-top: 8px;
`;
const ColumnSelector$1 = React.forwardRef((props, ref) => {
    ...
    React.useImperativeHandle(ref, () => ({ setColumn }), [state.columnSelectorReducer.visibleColumns]);
    if (!state.dataTableReducer.columns.length)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(edsCoreReact.Tooltip, Object.assign({ title: "Manage columns", placement: "top" }, { children: jsxRuntime.jsxs(edsCoreReact.Button, Object.assign({ variant: "ghost", onClick: () => { var _a; return (_a = dialogRef === null || dialogRef === void 0 ? void 0 : dialogRef.current) === null || _a === void 0 ? void 0 : _a.open(); } }, { children: [title, icon] }), void 0) }), void 0), jsxRuntime.jsxs(Dialog, Object.assign({ title: title, width: 800, primaryButton: "Reset", cancelButton: "Close", noLoading: true, onPrimary: handleResetColumns, ref: dialogRef }, { children: [jsxRuntime.jsx(edsCoreReact.Typography, Object.assign({ variant: "h6" }, { children: "Default columns" }), void 0), jsxRuntime.jsx(OptionsWrapper, { children: state.dataTableReducer.columns.filter((x) => !x.props.optional && !x.props.id.startsWith('__')).map((column) => {
                            var _a;
                            return (jsxRuntime.jsx(edsCoreReact.Checkbox, { label: column.props.children, checked: (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id), onChange: () => handleChange(column) }, column.props.id));
                        }) }, void 0), jsxRuntime.jsx(edsCoreReact.Typography, Object.assign({ variant: "h6" }, { children: "Optional columns" }), void 0), jsxRuntime.jsx(OptionsWrapper, { children: state.dataTableReducer.columns.filter((x) => x.props.optional && !x.props.id.startsWith('__')).map((column) => {
                            var _a;
                            return (jsxRuntime.jsx(edsCoreReact.Checkbox, { label: column.props.children, checked: (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id), onChange: () => handleChange(column) }, column.props.id));
                        }) }, void 0)] }), void 0)] }, void 0));
});
...
const Export$1 = ({ title, icon }) => {
    const dialogRef = React.useRef(null);
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(edsCoreReact.Tooltip, Object.assign({ title: "Export data", placement: "top" }, { children: jsxRuntime.jsxs(edsCoreReact.Button, Object.assign({ variant: "ghost", onClick: () => { var _a; return (_a = dialogRef === null || dialogRef === void 0 ? void 0 : dialogRef.current) === null || _a === void 0 ? void 0 : _a.open(); } }, { children: [title, icon] }), void 0) }), void 0), jsxRuntime.jsx(Dialog, Object.assign({ title: title, width: 800, primaryButton: "Export", cancelButton: "Close", noLoading: true, onPrimary: () => { }, ref: dialogRef }, { children: jsxRuntime.jsx(edsCoreReact.Typography, Object.assign({ variant: "h6" }, { children: "NOT IMPLEMENTED YET" }), void 0) }), void 0)] }, void 0));
};

var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};

var tokens_umd = {exports: {}};
...
}(tokens_umd, tokens_umd.exports));

const { colors: { infographic: { primary__moss_green_34: { hex: selectedBgColor }, }, }, } = tokens_umd.exports.tokens;
const Wrapper$6 = styled__default["default"].div `
    ...
    padding-top: 32px;
`;
const Pagination$1 = ({ count, defaultPageSize }) => {
    const state = React.useContext(StateContext$1);
    const dispatch = React.useContext(DispatchContext$1);
     ...
     * @param value
     */
    const handleChangePage = (_e, payload) => {
    ...
    if (!pageSize)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsxs(Wrapper$6, { children: [jsxRuntime.jsx(edsCoreReact.NativeSelect, Object.assign({ id: "", label: "", value: +pageSize, onChange: handleChangePageSize }, { children: pageSizeOptions.map((pageSize) => jsxRuntime.jsxs("option", Object.assign({ value: pageSize }, { children: [pageSize, " / page"] }), `pageSize-${pageSize}`)) }), `pageSize-${+pageSize}`), jsxRuntime.jsx(edsCoreReact.Pagination, { totalItems: count || 0, itemsPerPage: +pageSize, defaultPage: +pageIndex, withItemIndicator: true, 
                // @ts-ignore
                onChange: handleChangePage, style: {
                    // @ts-ignore
                    '--eds_interactive_primary__selected_highlight': selectedBgColor,
                } }, `pageIndex-${+pageIndex}`)] }, void 0));
};

const SET_COLUMNS$1 = "SET_COLUMNS";
const SET_PLUGIN_COLUMN_PROPS = "SET_PLUGIN_COLUMN_PROPS";
...
const reducer$a = (state = initialState$a, action) => {
    switch (action.type) {
        case SET_DATA$1:
            return Object.assign(Object.assign({}, state), { data: action.payload });
        case SET_COLUMNS$1:
            return Object.assign(Object.assign({}, state), { columns: action.payload });
        case SET_PLUGIN_COLUMN_PROPS:
            return Object.assign(Object.assign({}, state), { pluginColumnProps: action.payload });
        case SET_QUERY:
            return Object.assign(Object.assign({}, state), { query: action.payload });
        default:
            return state;
    }
};
const dataTableReducer = { reducer: reducer$a, initialState: initialState$a };
...
const Wrapper$5 = styled__default["default"].div `
    ...
    padding-bottom: 16px;
`;
const Left = styled__default["default"].div `
    justify-content: left;
    width: 100%;
    display: inline-flex;
    align-items: center;
`;
const Right = styled__default["default"].div `
    justify-content: right;
    width: 100%;
    display: inline-flex;
    align-items: center;
`;
const RightInner = styled__default["default"].div `
    padding-left: 16px;
`;
const Toolbar$1 = ({ children, components }) => {
    React.useContext(DispatchContext$1);
    return (jsxRuntime.jsxs(Wrapper$5, { children: [jsxRuntime.jsx(Left, { children: components && components.filter((x) => x.props.placement === 'left' || !x.props.placement).map((component, index) => (jsxRuntime.jsx(React__default["default"].Fragment, { children: component.props.children }, `lt-${index}`))) }, void 0), jsxRuntime.jsxs(Right, { children: [children, components && components.filter((x) => x.props.placement === 'right').map((component, index) => (jsxRuntime.jsx(RightInner, { children: component.props.children }, `rt-${index}`)))] }, void 0)] }, void 0));
};
...
const Head = styled__default["default"](edsCoreReact.Table.Head) `
    ...
    white-space: normal;
`;
const StickyTable = styled__default["default"](edsCoreReact.Table) `
    position: fixed;
    top: ${(props) => (props.threshold > 0 ? `${props.threshold}px` : '0')};
    visibility: ${(props) => (props.stick ? 'visible' : 'hidden')};
    overflow: hidden;
    z-index: 9;
`;
const StickyHeader$1 = React.forwardRef((props, ref) => {
    var _a;
    ...
    const determineStickyState = () => {
        if (!headerElement || typeof threshold === 'undefined')
            return;
        const boundingBox = headerElement === null || headerElement === void 0 ? void 0 : headerElement.getBoundingClientRect();
    ...
    left.current = headerElement === null || headerElement === void 0 ? void 0 : headerElement.getBoundingClientRect().left;
    if (!state.stickyHeaderReducer.width)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsx(StickyTable, Object.assign({ stick: stick, threshold: threshold }, { children: jsxRuntime.jsx(Head, Object.assign({ id: `dataTable.stickyHeaderRow.${id}` }, { children: jsxRuntime.jsxs(edsCoreReact.Table.Row, { children: [state.checkboxReducer && (jsxRuntime.jsx(CheckboxHeaderCell, {}, "checkbox-header")), (_a = state.dataTableReducer.columns) === null || _a === void 0 ? void 0 : _a.filter((x) => { var _a; return (_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(x.props.id); }).map((column) => (jsxRuntime.jsx(HeaderCell, { width: state.stickyHeaderReducer.width[column.props.id], id: `sticky-${column.props.id}`, column: column, onClick: () => handleClick(column.props) }, column.props.id)))] }, void 0) }), void 0) }), void 0));
});

edsCoreReact.Icon.add({ chevron_down, chevron_right });
const Wrapper$4 = styled__default["default"].span `
    display: grid;
    grid-template-columns: ${(props) => `${props.depth * 40}px 40px min-content`};
    height: 100%;
...
`;
const Button = styled__default["default"](edsCoreReact.Button) `
    z-index: 999;
`;
const TreeCellRender = (props) => {
    ...
    return (jsxRuntime.jsx(edsCoreReact.EdsProvider, Object.assign({ density: "compact" }, { children: jsxRuntime.jsxs(Wrapper$4, Object.assign({ depth: depth || 0 }, { children: [jsxRuntime.jsx("div", {}, void 0), item.children ? (jsxRuntime.jsx(Button, Object.assign({ variant: "ghost_icon", onClick: handleClick }, { children: jsxRuntime.jsx(edsCoreReact.Icon, { name: isOpen() ? 'chevron_down' : 'chevron_right', size: 24, style: { color: "#007079" } }, void 0) }), void 0)) : jsxRuntime.jsx("div", {}, void 0), jsxRuntime.jsx("span", Object.assign({ style: { display: 'inline-block', alignSelf: 'center', paddingLeft: '4px' } }, { children: content }), void 0)] }), void 0) }), void 0));
};
...
const Checkbox$1 = ({ onChange }) => {
    ...
    React.useEffect(() => {
        if (typeof onChange === 'function')
            onChange(state.checkboxReducer.selected);
...
`;
const DataTable$1 = React__default["default"].memo((props) => {
    ...
    const tree = components.find((x) => x.type.displayName === 'DataTable.Tree');
    const filter = components.find((x) => x.type.displayName === 'DataTable.Filter');
    const checkbox = components.find((x) => x.type.displayName === 'DataTable.Checkbox');
    ...
    return (jsxRuntime.jsx(DataTableStore, Object.assign({ components: components, reducers: Object.assign({ dataTableReducer }, reducers) }, { children: jsxRuntime.jsxs(Wrapper$3, { children: [jsxRuntime.jsx(Toolbar$1, Object.assign({ components: components.filter((x) => x.type.displayName === 'DataTable.Toolbar') }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [exportPlugin && jsxRuntime.jsx(Export$1, Object.assign({}, exportPlugin.props), void 0), columnSelector && jsxRuntime.jsx(ColumnSelector$1, Object.assign({}, columnSelector.props, { ref: columnSelector.ref }), void 0), filter && jsxRuntime.jsx(Filter$1, Object.assign({}, filter.props), void 0)] }, void 0) }), void 0), jsxRuntime.jsxs(TableWrapper, Object.assign({ ref: wrapperRef }, { children: [stickyHeader && jsxRuntime.jsx(StickyHeader$1, Object.assign({}, stickyHeader.props, { id: id, ref: stickyHeader.ref }), void 0), jsxRuntime.jsxs(edsCoreReact.Table, Object.assign({ style: { width: '100%' } }, { children: [jsxRuntime.jsx(Header$1, Object.assign({ id: id }, { children: components.filter((x) => x.type.displayName === 'DataTable.Column') }), void 0), jsxRuntime.jsx(Body, Object.assign({ id: id }, row === null || row === void 0 ? void 0 : row.props, { data: data && getData ? getData(data) : data, onFetch: onFetch }), void 0)] }), void 0)] }), void 0), pagination && jsxRuntime.jsx(Pagination$1, Object.assign({ count: pagination.props.getCount(data || 0) }, pagination.props), void 0), tree && jsxRuntime.jsx(Tree$1, Object.assign({}, tree.props), void 0), checkbox && jsxRuntime.jsx(Checkbox$1, Object.assign({}, checkbox.props), void 0)] }, void 0) }), void 0));
});

const Row$1 = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props), void 0));
};
...
const reducer$9 = (state = initialState$9, action) => {
    const getDefaultVisibleColumns = (columns) => {
        ...
        columns.forEach((column) => {
            if (typeof column.props.optional === 'undefined') {
                if (column.props.id)
                    visibleColumns.push(column.props.id);
            }
        });
    ...
    switch (action.type) {
        case SET_COLUMNS:
            ...
            return Object.assign(Object.assign({}, state), { visibleColumns: getDefaultVisibleColumns(action.payload) });
        case SET_VISIBLE_COLUMNS:
            return Object.assign(Object.assign({}, state), { visibleColumns: action.payload });
...
const columnSelectorReducer = { reducer: reducer$9, initialState: initialState$9 };

const ColumnSelector = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "ColumnSelector" }), void 0));
};
ColumnSelector.reducer = { columnSelectorReducer };

const Export = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "Export" }), void 0));
};

const Column = ({ children }) => {
    return (jsxRuntime.jsx(edsCoreReact.Table.Cell, { children: children }, void 0));
};
...
const reducer$8 = (state = initialState$8, action) => {
    switch (action.type) {
        ...
        case SET_PAGE_SIZE:
            return Object.assign(Object.assign({}, state), { pageSize: action.payload });
        default:
            return state;
    }
};
const paginationReducer = { reducer: reducer$8, initialState: initialState$8 };
...
const Pagination = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "Pagination" }), void 0));
};
...
const reducer$7 = (state = initialState$7, action) => {
    ...
    switch (action.type) {
        case TREE_TOGGLE:
            ...
            return Object.assign(Object.assign({}, state), { open: tmp });
        default:
            return state;
    }
};
const treeReducer = { reducer: reducer$7, initialState: initialState$7 };

const Tree = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "Tree" }), void 0));
};
 ...
 */
const Toolbar = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "Toolbar" }), void 0));
};
...
const CALCULATE_COLUMN_WIDTH = "CALCULATE_COLUMN_WIDTH";
...
const reducer$6 = (state = initialState$6, action) => {
     ...
     * @returns void
     */
    const calculateColumnWidth = (visibleColumns, id) => {
        const headerElement = document.getElementById(`dataTable.headerRow.${id}`);
        if (!headerElement)
            return;
        const payload = {};
...
const stickyHeaderReducer = { reducer: reducer$6, initialState: initialState$6 };

const StickyHeader = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "StickyHeader" }), void 0));
};
StickyHeader.reducer = { stickyHeaderReducer };

const DefaultQuery$1 = () => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, { children: "DefaultQuery" }, void 0));
};
...
const Checkbox = (props) => {
    return (jsxRuntime.jsx(React__default["default"].Fragment, Object.assign({}, props, { children: "Checkbox" }), void 0));
};
...
const defaultQueryReducer = { reducer: reducer$4, initialState: initialState$4, component: component$1 };
 ...
 */
function l$1(e){return e==null?!1:Array.isArray(e)||typeof e=="string"?!!e.length:g__default["default"](e)?!!Object.keys(e).length:typeof e=="number"}
 ...
 */
var K={arrayVsArrayAllMustBeFound:"any",caseSensitive:!0};function $(e,a,c){if(!e.length||!a.length)return !1;let E={...K,...c},t=typeof e=="string"?[e]:Array.from(e);return typeof a=="string"?t.some(i=>isMatch(i,a,{caseSensitive:E.caseSensitive})):E.arrayVsArrayAllMustBeFound==="any"?a.some(i=>t.some(r=>isMatch(r,i,{caseSensitive:E.caseSensitive}))):a.every(i=>t.some(r=>isMatch(r,i,{caseSensitive:E.caseSensitive})))}function R(e){return typeof e=="string"}function I(e){return typeof e=="number"}function D(e){return typeof e=="boolean"}var m$1=Array.isArray;function S(e){return !!e&&e.some(a=>typeof a=="string")}function J(e,a){return Object.keys(e).length===0||Object.keys(a).length===0||Object.keys(e).every(c=>Object.keys(a).includes(c))||Object.keys(a).every(c=>Object.keys(e).includes(c))}function h$1(e){return e===null?"null":k__default["default"](e)?"date":g__default["default"](e)?"object":m$1(e)?"array":typeof e}var C={cb:null,mergeObjectsOnlyWhenKeysetMatches:!0,ignoreKeys:[],hardMergeKeys:[],hardArrayConcatKeys:[],mergeArraysContainingStringsToBeEmpty:!1,oneToManyArrayObjectMerge:!1,hardMergeEverything:!1,hardArrayConcat:!1,ignoreEverything:!1,concatInsteadOfMerging:!0,dedupeStringsInArrayValues:!1,mergeBoolsUsingOrNotAnd:!0,useNullAsExplicitFalse:!1};function b$1(e,a,c,E){let t={...C,...E};typeof t.ignoreKeys=="string"&&(t.ignoreKeys=[t.ignoreKeys]),typeof t.hardMergeKeys=="string"&&(t.hardMergeKeys=[t.hardMergeKeys]),t.hardMergeKeys.includes("*")&&(t.hardMergeEverything=!0),t.ignoreKeys.includes("*")&&(t.ignoreEverything=!0);let i;if(t.useNullAsExplicitFalse&&(a===null||c===null))return typeof t.cb=="function"?t.cb(a,c,null,{path:e.path,key:e.key,type:e.type}):null;let r=m$1(a)||g__default["default"](a)?s__default["default"](a):a,n=m$1(c)||g__default["default"](c)?s__default["default"](c):c,o;t.ignoreEverything?o=r:t.hardMergeEverything&&(o=n);let p=t.hardMergeEverything||t.ignoreEverything;if(m$1(r))if(l$1(r))if(m$1(n)&&l$1(n)){if(t.mergeArraysContainingStringsToBeEmpty&&(S(r)||S(n))){let l=p?o:[];return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:i,key:e.key,type:e.type}):l}if(t.hardArrayConcat){let l=p?o:r.concat(n);return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:i,key:e.key,type:e.type}):l}let y=[];for(let l=0,d=Math.max(r.length,n.length);l<d;l++)i=e.path?.length?`${e.path}.${l}`:`${l}`,g__default["default"](r[l])&&g__default["default"](n[l])&&(t.mergeObjectsOnlyWhenKeysetMatches&&J(r[l],n[l])||!t.mergeObjectsOnlyWhenKeysetMatches)?y.push(b$1({path:i,key:e.key,type:[h$1(r),h$1(n)]},r[l],n[l],t)):t.oneToManyArrayObjectMerge&&(r.length===1||n.length===1)?y.push(r.length===1?b$1({path:i,key:e.key,type:[h$1(r),h$1(n)]},r[0],n[l],t):b$1({path:i,key:e.key,type:[h$1(r),h$1(n)]},r[l],n[0],t)):t.concatInsteadOfMerging?(l<r.length&&y.push(r[l]),l<n.length&&y.push(n[l])):(l<r.length&&y.push(r[l]),l<n.length&&!T__default["default"](r,n[l])&&y.push(n[l]));t.dedupeStringsInArrayValues&&y.every(l=>R(l))&&(y=x__default["default"](y).sort()),r=s__default["default"](y);}else {let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:i,key:e.key,type:e.type}):y}else {if(l$1(n)){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:i,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:i,key:e.key,type:e.type}):y}else if(g__default["default"](r)){if(l$1(r)){if(m$1(n)){if(l$1(n)){let u=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),u,{path:i,key:e.key,type:e.type}):u}let d=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),d,{path:i,key:e.key,type:e.type}):d}if(g__default["default"](n)){Object.keys(n).forEach(u=>{i=e.path?.length?`${e.path}.${u}`:`${u}`,r.hasOwnProperty(u)?$(u,t.ignoreKeys)?r[u]=b$1({path:i,key:u,type:[h$1(r),h$1(n)]},r[u],n[u],{...t,ignoreEverything:!0}):$(u,t.hardMergeKeys)?r[u]=b$1({path:i,key:u,type:[h$1(r),h$1(n)]},r[u],n[u],{...t,hardMergeEverything:!0}):$(u,t.hardArrayConcatKeys)?r[u]=b$1({path:i,key:u,type:[h$1(r),h$1(n)]},r[u],n[u],{...t,hardArrayConcat:!0}):r[u]=b$1({path:i,key:u,type:[h$1(r[u]),h$1(n[u])]},r[u],n[u],t):r[u]=n[u];});let d=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),d,{path:e.path,key:e.key,type:e.type}):r}let l=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}if(m$1(n)||g__default["default"](n)||l$1(n)){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else if(k__default["default"](r)){if(M__default["default"](+r)){if(k__default["default"](n)){if(M__default["default"](+n)){let u=p?o:r>n?r:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),u,{path:e.path,key:e.key,type:e.type}):u}let d=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),d,{path:e.path,key:e.key,type:e.type}):d}let l=p?o:n||r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}if(k__default["default"](n)){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else if(R(r)){if(l$1(r)){if((m$1(n)||g__default["default"](n)||R(n))&&l$1(n)){let d=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),d,{path:e.path,key:e.key,type:e.type}):d}let l=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}if(n!=null&&!D(n)){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else if(I(r)){if(l$1(n)){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else if(D(r)){if(D(n)){if(t.mergeBoolsUsingOrNotAnd){let d=p?o:r||n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),d,{path:e.path,key:e.key,type:e.type}):d}let l=p?o:r&&n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}if(n!=null){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else if(r===null){if(n!=null){let l=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),l,{path:e.path,key:e.key,type:e.type}):l}let y=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}else {let y=p?o:n;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),y,{path:e.path,key:e.key,type:e.type}):y}let v=p?o:r;return typeof t.cb=="function"?t.cb(s__default["default"](a),s__default["default"](c),v,{path:e.path,key:e.key,type:e.type}):v}function X(e,a,c){if(!arguments.length)throw new TypeError("object-merge-advanced/mergeAdvanced(): [THROW_ID_01] Both inputs are missing");return b$1({key:null,path:"",type:[h$1(e),h$1(a)]},e,a,c)}

/* eslint-disable no-cond-assign */
class FilterParser {
    constructor(params, config) {
        this.composeQuery = (obj) => {
            const run = (obj) => {
                for (const k in obj) {
        ...
        this.parse = () => {
            ...
            let query = buildQuery(Object.assign({ filter: this.filter, orderBy: this.sort }, this.pagination));
        ...
        this.stripSingleQuoteFromDateTime = (query) => {
            const regex = / ge [\w\d\S]*| le [\w\d\S]*/gi;
            return query.replace(regex, (match) => match.replaceAll("'", ''));
        };
        /**
         ...
         */
        this.isCommaSeparatedString = (value) => value.includes(',');
        this.stdTimezoneOffset = () => {
            const jan = new Date(0, 1);
            const jul = new Date(6, 1);
            return Math.max(jan.getTimezoneOffset(), jul.getTimezoneOffset());
        };
        this.isDstObserved = (today) => today.getTimezoneOffset() < this.stdTimezoneOffset();
        this.isDateString = (str) => {
        ...
        this.parseArray = (value) => {
            const items = value.split(',');
            if (items.length > 0) {
                const parsed = items.map((x) => (!isNaN(x) ? parseFloat(x) : x));
                return parsed;
            }
            return !isNaN(value) ? parseFloat(value) : value;
        };
        this.parseStringArray = (value) => {
            const items = value.split(',');
            if (items.length > 0) {
                return items;
            }
    ...
    init() {
        ...
        this.params.forEach((value, key, _searchParams) => {
            if (this.logging) {
            ...
            if (key === 'sort') {
                ...
                this.filter = X(this.filter, this.getFilter(value, key), {});
            }
        });
        return this;
    }
     ...
     * @returns FilterParser
     */
    getGreaterThanFilter(value, key) {
     ...
     * @returns FilterParser
     */
    getArrayFilter(value, key) {
        // Removes '[]' at the end
        key = key.slice(0, -2);
        const result = { in: this.parseArray(value) };
        return this.appendKeys(key, result);
    }
    /**
     ...
     * @returns FilterParser
     */
    getStringArrayFilter(value, key) {
        // Removes '[str]' at the end
        key = key.slice(0, -5);
        const result = { in: this.parseStringArray(value) };
        return this.appendKeys(key, result);
    }
    /**
     ...
     * @returns FilterParser
     */
    getContainsFilter(value, key) {
        value = value.substring(1, value.length - 1);
        let result = [...new Set(key.split('|').map((x) => ({ [x]: { contains: value } })))];
...
const ODataQuery = ({ state, dispatch }) => {
    const navigate = reactRouterDom.useNavigate();
    const location = reactRouterDom.useLocation();
    const sortingInitialized = React.useRef(false);
    const paginationInitialized = React.useRef(false);
...
const oDataQueryReducer = { reducer: reducer$3, initialState: initialState$3, component };
...
const reducer$2 = (state = initialState$2, action) => {
    switch (action.type) {
        case SET_ORDER_BY:
            return Object.assign(Object.assign({}, state), { orderBy: action.payload });
        case SET_DIRECTION:
            return Object.assign(Object.assign({}, state), { ascending: action.payload });
        case SORT:
            return Object.assign(Object.assign({}, state), { orderBy: action.payload, ascending: state.ascending ? false : true });
        default:
            return state;
    }
};
const sortingReducer = { reducer: reducer$2, initialState: initialState$2 };

const DataTable = DataTable$1;
DataTable.Checkbox = Checkbox;
DataTable.Column = Column;
DataTable.ColumnSelector = ColumnSelector;
DataTable.DefaultQuery = DefaultQuery$1;
...
const reducer$1 = (state = initialState$1, action) => {
    switch (action.type) {
        case SET_DEFAULT_DATA:
            return Object.assign(Object.assign({}, state), { data: action.payload, defaultData: action.payload });
        case SET_DATA:
            return Object.assign(Object.assign({}, state), { data: action.payload });
        case RESET_TO_DEFAULT:
            return Object.assign(Object.assign({}, state), { data: state.defaultData });
        default:
            return state;
    }
};
const formReducer = { reducer: reducer$1, initialState: initialState$1 };
...
const FormStore = (props) => {
    ...
    Object.fromEntries(Object.entries(reducers).map(([name, reducer]) => [name, React.useReducer(reducer.reducer, reducer.initialState)])));
    return (jsxRuntime.jsx(DispatchContext.Provider, Object.assign({ value: dispatch }, { children: jsxRuntime.jsx(StateContext.Provider, Object.assign({ value: state }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [children, plugins.map((plugin) => {
                        return jsxRuntime.jsx(React__default["default"].Fragment, { children: plugin({ state, dispatch }) }, plugin.name);
                    })] }, void 0) }), void 0) }), void 0));
};
...
const FormWrapper = React.forwardRef((props, ref) => {
    ...
    const update = (payload) => {
        if (payload.target) {
            ...
            dispatch({ type: 'SET_DATA', payload: Object.assign(Object.assign({}, state.formReducer.data), { [id]: value }) });
        }
        else {
            dispatch({ type: 'SET_DATA', payload: Object.assign(Object.assign({}, state.formReducer.data), payload) });
        }
    };
    return props.children({ data: state.formReducer.data, submit, cancel, update });
});

const Validation$1 = ({ errors }) => {
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        case SET_ERRORS:
            return Object.assign(Object.assign({}, state), { errors: action.payload });
        default:
            return state;
    }
};
const validationReducer = { reducer, initialState };

const ColumnsWrapper = styled__default["default"].div `
    display: grid;
    grid-template-rows: ${(props) => Array(props.count + 1).join('max-content ')};
    grid-row-gap: 12px;
    width: 100%;
`;
/**
...
const Form$1 = React.forwardRef((props, ref) => {
    ...
    const validation = Array.isArray(props.children) ? props.children.find((x) => { var _a; return ((_a = x.type) === null || _a === void 0 ? void 0 : _a.displayName) === 'Form.Validation'; }) : undefined;
    const inputFields = Array.isArray(props.children) ? props.children.find((x) => typeof x === 'function') : props.children;
    return (jsxRuntime.jsxs(FormStore, Object.assign({ reducers: Object.assign({ formReducer,
            validationReducer }, reducers) }, { children: [validation && jsxRuntime.jsx(Validation$1, Object.assign({}, validation.props), void 0), jsxRuntime.jsx(ColumnsWrapper, Object.assign({ count: children.length }, { children: jsxRuntime.jsx(FormWrapper, Object.assign({}, props, { children: inputFields }), void 0) }), void 0)] }), void 0));
});
...
const Row = (props) => {
    ...
    const gap = 20;
    const children = React.Children.toArray(props.children);
    return (jsxRuntime.jsx(Wrapper$2, Object.assign({ count: children.length, gap: gap, width: 300 }, { children: React.Children.map(children, (child, index) => {
            if (fixed) {
                return (jsxRuntime.jsx(FixedInner$1, Object.assign({ fixed: fixed, count: children.length, gap: gap }, { children: React.cloneElement(child, {}) }), void 0));
            }
            else {
                return (jsxRuntime.jsx(DynamicInner$1, Object.assign({ count: children.length, gap: gap }, { children: React.cloneElement(child, {}) }), void 0));
            }
        }) }), void 0));
};

const Wrapper$1 = styled__default["default"].span `
    display: inline-flex;
    width: 100%;
...
const Label$1 = (props) => {
    ...
    return (jsxRuntime.jsxs(Wrapper$1, { children: [jsxRuntime.jsx(Item, { children: children }, void 0), meta && (jsxRuntime.jsx(Item, { children: meta }, void 0))] }, void 0));
};
 ...
 * TODO: Refactor
 */
const FixedInner = styled__default["default"].div `
    min-width: ${(props) => `${props.fixed}px`};
    /* width: ${(props) => `calc(100% / ${props.count} - ${props.gap * (props.count - 1) / props.count}px)`}; */
`;
const DynamicInner = styled__default["default"].div `
    /* width: ${(props) => `calc(100% / ${props.count} - ${props.gap * (props.count - 1) / props.count}px)`}; */
`;
const Actions = (props) => {
    const { fixed } = props;
    const gap = 10;
    const children = React.Children.toArray(props.children);
    return (jsxRuntime.jsx(Wrapper, Object.assign({ count: children.length, gap: gap }, { children: React.Children.map(children, (child, index) => {
            if (fixed) {
                return (jsxRuntime.jsx(FixedInner, Object.assign({ fixed: fixed, count: children.length, gap: gap }, { children: React.cloneElement(child, {}) }), void 0));
            }
            else {
                return (jsxRuntime.jsx(DynamicInner, Object.assign({ count: children.length, gap: gap }, { children: React.cloneElement(child, {}) }), void 0));
            }
        }) }), void 0));
};

edsCoreReact.Icon.add({ help_outline });
const StyledEdsTooltip = styled__default["default"](edsCoreReact.Tooltip) `
    &:hover {
        cursor: help;
    }

    max-width: ${(props) => { var _a; return (_a = props.maxWidth) !== null && _a !== void 0 ? _a : 300; }}px;
    white-space: normal;
`;
const StyledIcon = styled__default["default"](edsCoreReact.Icon) `
    fill: #6f6f6f;
    width: 16px;
    height: 16px;
    position: relative;
...
const Tooltip = (props) => {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: !disabled ? (jsxRuntime.jsx(StyledEdsTooltip, Object.assign({ className: className, title: title, open: open, placement: placement, maxWidth: maxWidth }, { children: children || (jsxRuntime.jsx(StyledIcon, { name: "help_outline", size: 16, color: "#007079" }, void 0)) }), void 0)) : (jsxRuntime.jsx(jsxRuntime.Fragment, { children: children }, void 0)) }, void 0));
};

const ReadOnly = (props) => {
    const { render, value, childKey } = props;
    if (render) {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: render({ options: value, getTagProps: () => { }, childKey }) }, void 0);
    }
    if (typeof value === 'object' && childKey) {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: value[childKey] }, void 0);
    }
    return jsxRuntime.jsx(jsxRuntime.Fragment, { children: value }, void 0);
};
...
const Header = styled__default["default"].div `
    ...
    white-space: nowrap;
`;
const ValidationError = styled__default["default"](edsCoreReact.Label) `
    color: rgb(235, 0, 0);
    margin-top: 4px;
    height: 16px;
`;
const Label = styled__default["default"](edsCoreReact.Label) `
    height: 16px;
...
const Empty = styled__default["default"].div `
    ...
    height: 16px;
`;
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        var _a;
        ...
        React.useEffect(() => {
            var _a;
            const values = (_a = state.validationReducer) === null || _a === void 0 ? void 0 : _a.errors;
            if (values) {
        ...
        }, [(_a = state.validationReducer) === null || _a === void 0 ? void 0 : _a.errors]);
        /**
        ...
        return (jsxRuntime.jsxs(InputWrapper, { children: [jsxRuntime.jsxs(Header, { children: [label && jsxRuntime.jsx(Label, { style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, label: label }, void 0), tooltip && jsxRuntime.jsx(Tooltip, { title: tooltip, placement: "bottom" }, void 0), isRequired && jsxRuntime.jsx(Label, { label: '', style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, meta: '*Required' }, void 0)] }, void 0), edit ? jsxRuntime.jsx(Component, Object.assign({}, props), void 0) : jsxRuntime.jsx(ReadOnly, Object.assign({}, props), void 0), validationErrors ? validationErrors.map((validationError) => (jsxRuntime.jsx(ValidationError, { label: validationError }, void 0))) : jsxRuntime.jsx(Empty, {}, void 0)] }, void 0));
    };
    return Input;
};
...
const TextField = (props) => {
    ...
    return (jsxRuntime.jsx(edsCoreReact.TextField, { id: id, meta: meta, value: value || '', onChange: onChange, variant: error ? "error" : "default", helperText: error, helperIcon: error && jsxRuntime.jsx(edsCoreReact.Icon, { name: "error_filled", title: "Error" }, void 0), disabled: disabled }, void 0));
};
var TextField$1 = withInput()(TextField);
...
const SelectField = (props) => {
    ...
    const filterOption = ({ label }, input) => label !== null &&
        label !== undefined &&
    ...
    return (jsxRuntime.jsx(Select, { id: id, options: options, getOptionLabel: (option) => option.name, getOptionValue: (option) => option.id, value: options ? options.filter((x) => x.id === value) : {}, onChange: handleChange, 
        // placeholder={placeholder}
        isDisabled: isDisabled, 
        // theme={(theme: any) => equinorTheme(theme)}
        styles: {
            // Fixes the overlapping problem of the component
            menu: (provided) => (Object.assign(Object.assign({}, provided), { zIndex: 9999 })),
            menuPortal: (provided) => (Object.assign(Object.assign({}, provided), { zIndex: 9999 })),
            control: (provided) => (Object.assign(Object.assign({}, provided), { backgroundColor: "#F7F7F7", borderRadius: "0px", borderStyle: "none", borderBottom: "ridge" })),
        }, filterOption: filterOption, isClearable: true, menuPortalTarget: document.body, menuPosition: "fixed" }, void 0));
};
var SelectField$1 = withInput()(SelectField);
...
const useForm = (defaultData, props) => {
    ...
    const update = (e) => {
        ...
        if (type === 'checkbox') {
            setData((state) => (Object.assign(Object.assign({}, state), { [id]: checked })));
        }
        else {
            setData((state) => (Object.assign(Object.assign({}, state), { [id]: value })));
        }
    };
    React.useEffect(() => {
        if (!defaultData) {
...
Form.TextField = TextField$1;
Form.SelectField = SelectField$1;
...
exports.stickyHeaderReducer = stickyHeaderReducer;
