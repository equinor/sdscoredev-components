...
const Row$2 = React.forwardRef((props, ref) => {
    ...
    if (!props.data || !state.dataTableReducer.columns)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
    return (jsxRuntime.jsxs(DefaultRow, Object.assign({ role: "row", ref: ref }, { children: [state.checkboxReducer &&
                jsxRuntime.jsx(CheckboxCell, { item: props.data }, `checkbox-header-${props.data.id}`), state.dataTableReducer.columns.map((column) => {
                var _a;
                return (jsxRuntime.jsx(React__default["default"].Fragment, { children: ((_a = state.columnSelectorReducer.visibleColumns) === null || _a === void 0 ? void 0 : _a.includes(column.props.id)) ? (jsxRuntime.jsx(Cell, Object.assign({}, props, { column: column, onClick: handleClick, item: props.data, href: props.getLink ? props.getLink(props.data) : undefined }), void 0)) : jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0) }, `${column.props.id}-${props.data.id}`));
            })] }), void 0));
});
...
const Right = styled__default["default"].div `
    ...
    align-items: center;
`;
const Toolbar$1 = ({ children }) => {
    React.useContext(DispatchContext$1);
    return (jsxRuntime.jsxs(Wrapper$4, { children: [jsxRuntime.jsx(Left, {}, void 0), jsxRuntime.jsx(Right, { children: children }, void 0)] }, void 0));
};
...
const DataTable$1 = React.forwardRef((props, ref) => {
    ...
    const toolbar = components.find((x) => x.type.displayName === 'DataTable.Toolbar');
