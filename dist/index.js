...
const Body = React.forwardRef((props, ref) => {
    ...
    const generateRows = (items, depth = undefined) => {
        ...
        return items.map((item, index) => (jsxRuntime.jsxs(React__default["default"].Fragment, { children: [React.createElement(Row$2, Object.assign({}, props, { depth: depth, data: item, ref: (el) => rowRef.current = el, key: `row-${item.id}` })), item.children && state.treeReducer.open.includes(item.id) && generateRows(item.children, depth)] }, index)));
    };
    if (!data)
        return jsxRuntime.jsx(jsxRuntime.Fragment, {}, void 0);
...
const withInput = ({ debounceTime = 0 } = {}) => (Component) => {
    const Input = (props) => {
        ...
        return (jsxRuntime.jsxs(InputWrapper, { children: [jsxRuntime.jsxs(Header, { children: [label && jsxRuntime.jsx(Label, { style: { color: disabled ? 'rgba(190, 190, 190, 1)' : 'unset' }, label: label, meta: isRequired ? '*Required' : undefined }, void 0), tooltip && jsxRuntime.jsx(Tooltip, { title: tooltip, placement: "bottom" }, void 0)] }, void 0), jsxRuntime.jsx(Component, Object.assign({}, props), void 0), validationErrors ? validationErrors.map((validationError) => (jsxRuntime.jsx(ValidationError, { label: validationError }, void 0))) : jsxRuntime.jsx(Empty, {}, void 0)] }, void 0));
    };
    return Input;
};
