...
export const ColumnSelector: React.FC<ColumnSelectorProps> = () => {
    ...
    return (
        <>
            <Tooltip title="Manage columns" placement="left">
                <Button variant="ghost_icon" onClick={() => dialogRef?.current?.open()} data-cy="manage-columns">
                    <Icon name="view_column" title="Manage columns" size={24} />
                </Button>
            </Tooltip>
