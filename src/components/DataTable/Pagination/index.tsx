...
export const Pagination: React.FC<InternalPaginationProps & PaginationProps> = ({ count }) => {
    ...
    // useEffect(() => {
    //     !pageIndex && dispatch({ type: "SET_PAGE_INDEX", payload: 1 })
    //     !pageSize && dispatch({ type: "SET_PAGE_SIZE", payload: defaultPageSize || 10 })
    // }, [])
