...
export const ReadOnlyValue = (props: any) => {
    ...
    if (render) {
        return (
            <Wrapper {...props} rightPadding={rightPadding}>
                {render({ value, getTagProps: undefined, childKey })}
            </Wrapper>
        );
    }
    ...
    if (typeof value === 'object' && value !== null) {
        return (
            <Wrapper data-cy={props['data-cy']} rightPadding={rightPadding}>
                {childKey && value[childKey] ? value[childKey] : value}
            </Wrapper>
        );
    }
